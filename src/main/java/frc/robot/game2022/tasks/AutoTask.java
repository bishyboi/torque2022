...
public class AutoTask {
    ...
    private final double horizontalShootingDistance = 9.5 + 15.5; // HORIZONTAL distance from reflective tape to camera
                                                                  // when shooting
        ...
        switch (phase) {
            ...
            case 2: // phase 2: move in
                ...
                if (count < 7.5 * 50) { // first 7.5 secs:
                    ...
                    {
                        phase--;
                    } else if (camera.getDistanceAdjust(horizontalShootingDistance, errorMargin) == 0) // good angle and
                                                                                                       // distance: next
                                                                                                       // phase and
                                                                                                       // reset count
                                                                                                       // for phase 3
            ...
            case 4: // phase 4: move out
                ...
                driveTrain.drivePercentageOutput(-0.2, 0.2);
                break;
        }
    }
