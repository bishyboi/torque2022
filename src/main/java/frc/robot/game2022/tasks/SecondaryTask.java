...
public class SecondaryTask {
    ...
    /*
     * Controls the percent of maximum power that a motor can output using
     * talon.set(ControlMode.PercentOutput, power)
     * This is a static amount that controls how fast each of the secondary motors
     * will move,
     * adjust between 0.1-1.0 to speed up and slow down the power of the secondary
     * motors
     */
    ...
    public void teleop() {
        ...
        // but won't allow it if it will exceed sensor limit determined in Combine.java
        // (canMove())
