...
public class DriverTask // TODO: clean up driver task with unused code
{
    ...
    /**
     * Runs the driver controller during teleop period. Constantly cycled through in
     * teleopPeriodic()
     */
    public void teleop() {
        ...
        // double turnFactor =
        // deadband(driver.getAxis(ConfigurationService.RIGHT_X_AXIS));
        ...
        // To make sure no side go OutOfBounds with the power and crash the code (other
        // side is divdided to keep relative power)
        ...
        // Drive the robot. Should always be last line and alone! Mostly used for
        // debugging
    ...
    // /**
    // * Checks to see if the driver wants to automatically drive to a vision
    // target/piece dropoff
