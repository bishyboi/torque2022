...
// public static final double kaVolts = 0.2;//SecondsSquaredPerMeter |
// Acceleration
...
// private final double driveTrainWidth = 23.8; //Width between wheels from end
// to end (from middle to middle is 23.0)
// private DriveTrain driveTrain;
// private Camera camera;
// private DifferentialDriveKinematics kinematics; //help change chassis-speed
// to individual wheel speed
// private DifferentialDriveOdometry odometry; //helps estimate position and
// orientation
...
// kinematics = new
// DifferentialDriveKinematics(Units.inchesToMeters(driveTrainWidth));
...
// config = new
// TrajectoryConfig(maxVelocity,maxAcceleration).setKinematics(kinematics)
// .addConstraint(voltageConstraint);

// trajectory = TrajectoryGenerator.generateTrajectory(startPose, path,
// finalPose, config);

// var initialState = trajectory.sample(0);
// initialSpeeds = kinematics.toWheelSpeeds(new
// ChassisSpeeds(initialState.velocityMetersPerSecond,0,
...
// //T O D O: Pose2d should be replaced with a function that supplies a list of
// Pose2ds
...
// public void update()
// {
// gyroAngle = Rotation2d.fromDegrees(0);//it's negative b/c Rotation2d uses a
// unit circle, but gyros have right = Positive
// currentPose = odometry.update(gyroAngle, driveTrain.getLeftPos(),
// driveTrain.getRightPos());//Distance NEEDS TO BE IN METERS
// }
