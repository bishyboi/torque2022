...
public class ConfigurationService
{
    ...
    public static final int ARM_LOWER                 = 4; //4
    public static final int ARM_UPPER                 = 5; //5
    public static final int COMBINE_INTAKE            = 6; //6
    public static final int COMBINE_LIFT              = 7; //7
