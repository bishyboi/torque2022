...
public class ColorSensor {
    ...
    // sees if sensor reading (sensor parameter) is close to a given preset color
    // (first input)
    public boolean inRange(Color8Bit expected, Color8Bit reading) {
        ...
        boolean greenInRange = (expected.green - uncertainty < reading.green
                && reading.green < expected.green + uncertainty);
        boolean blueInRange = (expected.blue - uncertainty < reading.blue
                && reading.blue < expected.blue + uncertainty);
